...
## Summary of Customer Journey Across Releases

The customer experience evolves across four releases:

- **Release 1:** APIs are prepared internally. There is no external customer access yet.
- **Release 2:** Customers receive guided, manual onboarding and support.
- **Release 3:** Customers begin to gain more independence through subscriptions and API key generation.
- **Release 4:** Customers can independently discover, understand, and access APIs through a full self-service experience.

This approach supports both Public Sector partners and Researchers, while reducing manual steps over time and improving speed of access.

---

# Release 1: API Availability for Integration
...
From a customer perspective, this release is important because it prepares the service for a smoother and more reliable onboarding experience in later phases. Customers will not yet be able to request access, generate keys, or use the APIs directly.

## Customer Experience

- No external customer onboarding.
- No customer-facing API discovery or documentation.
- Internal validation and preparation are completed before wider release.

## What This Enables for Customers

This release creates the technical foundation needed to provide customers with reliable API access in later phases [1].
...
- Clear support route.
- Reduced risk for early adopters.
- Suitable for customers who need help understanding how to use the APIs.
...
# Release 4: Full Self-Service API Access
...
- Customer can discover available APIs independently.
- Customer can access API documentation online.
- Customer can generate API keys without contacting SDF.
- Customer can integrate and scale usage at their own pace.

### Researchers

- Customer can browse available APIs.
- Customer can review documentation online.
- Customer can immediately generate API keys.
- Customer can begin exploration and analysis with minimal delay.
...
- No dependency on manual onboarding.
- Easier discovery and evaluation of APIs.
- Scalable for wider organisational adoption.

---

# Customer Experience Evolution

## Public Sector Journey

| Release | Customer Experience |
|---|---|
| Release 1 | No external access; APIs are prepared internally. |
| Release 2 | Fully guided access through an SDF contact. |
| Release 3 | Guided support remains, but customers gain partial self-service capabilities. |
| Release 4 | Fully independent and scalable self-service usage. |
